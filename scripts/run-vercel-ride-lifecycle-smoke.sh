...
npx playwright test tests/smoke/road-to-wao-vercel-ride-lifecycle-real.spec.js --reporter=line --timeout=120000 --output=/tmp/wao-vercel-ride-lifecycle
